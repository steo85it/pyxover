...
from examples.MLA.options import vecopts, auxdir, SpInterp, outdir, local, parallel, tmpdir
...
from src.pygeoloc.ground_track import gtrack
from examples.MLA.options import outdir, tmpdir
from examples.MLA.options import vecopts, auxdir, SpInterp
...
if __name__ == '__main__':
    ...
    from examples.MLA.options import expopt
