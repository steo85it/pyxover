...
parGlo = {} #'dL':1.e-1}#'dRA':[0.01, 0.000, 0.000], 'dDEC':[0.01, 0.000, 0.000],'dPM':[0, 0.001, 0.000], , 'dh2': 0.5} #'dRA':[0.01, 0.000, 0.000], 'dDEC':[0.01, 0.000, 0.000],'dPM':[0, 0.001, 0.000], 'dL':0.01, 'dh2': 0.5} # 'dL':0.1,'dRA':[0.01, 0.000, 0.000], 'dDEC':[0.001, 0.000, 0.000], 'dPM':[0.0, 0.00001, 0.0], 'dh2': 1.}
# parameter constraints for solution
par_constr = {'dR/dA': 200., 'dR/dC': 200., 'dR/dR': 50.} #, 'dR/dL':1} #, 'dR/dRA':1., 'dR/dDEC':1.,'dR/dPM':1., 'dR/dh2': 1., } #,'dR/dRA':10, 'dR/dDEC':10, 'dR/dPM':10, 'dR/dh2': 10.} #'dR/dA': 50,'dR/dC': 50,'dR/dR': 100, 'dR/dh2': 10} #'dR/dA': 100,'dR/dC': 50,'dR/dR': 100} #, 'dR/dC': 50, 'dR/dL': 0.001, 'dR/dh2': 0.001}
mean_constr = 1
# ... and closed loop sims
pert_cloop_orb = {} #'dA':50., 'dC':50., 'dR':10.} #'dA':100., 'dC':100., 'dR':20.} # {'dA':100., 'dC':100., 'dR':20.} # 'dRl':20e-6, 'dPt':60e-6} #
pert_cloop_glo = {} #'dL':0.01} #{'dRA':[0.02, 0.000, 0.000], 'dDEC':[0.05, 0.000, 0.000], 'dPM':[0, 0.002, 0.000], 'dh2': 0.8} # } #, 'dh2': 1.8,'dRA':[0.02, 0.000, 0.000], 'dDEC':[0.05, 0.000, 0.000], 'dPM':[0.0, 0.0005, 0.0]} #'dC':100., 'dR':20., 'dRl':20e-6, 'dPt':20e-6}
...
sol4_glo = [None] #'dR/dRA', 'dR/dDEC', 'dR/dPM','dR/dL'] #'dR/dRA', 'dR/dDEC', 'dR/dPM', 'dR/dh2']  # ,'dR/dh2','dR/dRA','dR/dDEC','dR/dPM']
