...
parGlo = {'dh2': 0.1} # 'dRA':[0.001, 0.000, 0.000], 'dDEC':[0.001, 0.000, 0.000],'dPM':[0, 1.e-8, 0.000], 'dL':1.e-2*np.linalg.norm([0.00993822,-0.00104581,-0.00010280,-0.00002364,-0.00000532])} #
# parameter constraints for solution
par_constr = {'dR/dh2': 10} # 'dR/dRA': 100., 'dR/dDEC': 100.,'dR/dL':100, 'dR/dPM': 100., 'dR/dA':100., 'dR/dC':100.,'dR/dR':50} #
mean_constr = 100
# ... and closed loop sims
pert_cloop_orb = {} #'dA':50., 'dC':50., 'dR':10.} #'dA':100., 'dC':100., 'dR':20.} # {'dA':100., 'dC':100., 'dR':20.} # 'dRl':20e-6, 'dPt':60e-6} #
pert_cloop_glo = {} #'dh2': -2.} #'dRA':[0.02, 0.000, 0.000], 'dDEC':[-0.01, 0.000, 0.000],'dPM':[0, 2.e-5, 0.000], 'dL':-0.5*np.linalg.norm([0.00993822,-0.00104581,-0.00010280,-0.00002364,-0.00000532])} # 'dRl':20e-6, 'dPt':20e-6}
...
sol4_glo = ['dR/dh2'] #'dR/dRA', 'dR/dDEC', 'dR/dPM', 'dR/dL'] #,  None]
