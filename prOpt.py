...
par_constr = {'dR/dRA': 1.e2, 'dR/dDEC': 1.e2,'dR/dL':1.e2, 'dR/dPM': 1.e2, 'dR/dh2':1.e-2, 'dR/dA':50., 'dR/dC':50.,'dR/dR':20., 'dR/dRl':1.e1, 'dR/dPt':1.e1} #
...
mean_constr = {'dR/dA':1.e-1, 'dR/dC':1.e-1,'dR/dR':1.e-1, 'dR/dRl':1.e-1, 'dR/dPt':1.e-1}
...
# in deg and deg/day as reminder pert_cloop_glo = {'dRA':[0.001, 0.000, 0.000], 'dDEC':[0.0013, 0.000, 0.000],'dPM':[0, 1.6e-5, 0.000],'dL':0.03*np.linalg.norm([0.00993822,-0.00104581,-0.00010280,-0.00002364,-0.00000532]), 'dh2':0.} # compatible with current uncertitudes
pert_cloop_glo = {'dRA':[3.*5., 0.000, 0.000], 'dDEC':[3.*5., 0.000, 0.000],'dPM':[0, 3.*8., 0.000],'dL':3.*0.03*deg2as(1.)*np.linalg.norm([0.00993822,-0.00104581,-0.00010280,-0.00002364,-0.00000532]), 'dh2':-1.} #
...
sol4_orbpar = [None] #'dA','dC','dR'] #,'dA1','dC1','dR1','dA2','dC2','dR2']  #] #,'dRl','dPt'] #
