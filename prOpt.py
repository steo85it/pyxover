...
parGlo = {'dRA':[0.005, 0.000, 0.000], 'dDEC':[0.005, 0.000, 0.000],'dPM':[0, 1.e-4, 0.000], 'dL':0.01, 'dh2': 0.1}  #'dRA':[0.01, 0.000, 0.000], 'dDEC':[0.001, 0.000, 0.000], 'dPM':[0.0, 0.00001, 0.0], 'dh2': 1.}

# parameter constraints for solution
par_constr = {'dR/dRA':1., 'dR/dDEC':1.,'dR/dPM':1.,'dR/dA': 50.,'dR/dC': 50.,'dR/dR':20., 'dR/dL':1.} #, 'dR/dh2': 0.001} #,'dR/dRA':10, 'dR/dDEC':10, 'dR/dPM':10, 'dR/dh2': 10.} #'dR/dA': 50,'dR/dC': 50,'dR/dR': 100, 'dR/dh2': 10} #'dR/dA': 100,'dR/dC': 50,'dR/dR': 100} #, 'dR/dC': 50, 'dR/dL': 0.001, 'dR/dh2': 0.001}
mean_constr = 100
...
sol4_orbpar = ['dR/dA','dR/dC','dR/dR']  # ['dA','dC','dR'] # 'dA','dC','dR'] #'dA','dC','dR'] #['dR0'] # 'dR/dA', 'dR/dC', 'dR/dR'] # ['dR/dA0','dR/dC0'] #['dR/dA'] #
sol4_glo = ['dR/dRA', 'dR/dDEC', 'dR/dPM','dR/dL','dR/dh2'] #'dR/dRA', 'dR/dDEC', 'dR/dPM', 'dR/dh2']  # ,'dR/dh2','dR/dRA','dR/dDEC','dR/dPM']
