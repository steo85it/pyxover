...
par_constr = {'dR/dRA': 1000., 'dR/dDEC': 1000.,'dR/dL':1000., 'dR/dPM': 1000., 'dR/dA':100., 'dR/dC':100.,'dR/dR':1, 'dR/dRl':1.e0, 'dR/dPt':1.e0} #, 'dR/dh2': 1} # 'dR/dA0':50., 'dR/dC0':50.,'dR/dR0':20, 'dR/dA1':1.e-2, 'dR/dC1':1.e-2,'dR/dR1':1.e-2} #
mean_constr = {'dR/dA':5.e0, 'dR/dC':5.e0,'dR/dR':1.e0, 'dR/dRl':1.e1, 'dR/dPt':1.e1}
...
sol4_orbpar = [None] #'dRl','dPt'] #'dA','dC','dR','dRl','dPt'] # 'dA1','dC1','dR1']  #
