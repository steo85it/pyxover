...
parGlo = {} #'dRA':[0.01, 0.000, 0.000], 'dDEC':[0.01, 0.000, 0.000],'dPM':[0, 0.001, 0.000], 'dh2': 0.1, 'dL':0.1} #,'dRA':[0.01, 0.000, 0.000], 'dDEC':[0.001, 0.000, 0.000], 'dPM':[0.0, 0.00001, 0.0], 'dh2': 1.}

# parameter constraints for solution
par_constr = {'dR/dA': 500., 'dR/dC': 500., 'dR/dR': 100.} #, 'dR/dL':1, 'dR/dRA':1., 'dR/dDEC':1.,'dR/dPM':1., 'dR/dh2': 1., } #,'dR/dRA':10, 'dR/dDEC':10, 'dR/dPM':10, 'dR/dh2': 10.} #'dR/dA': 50,'dR/dC': 50,'dR/dR': 100, 'dR/dh2': 10} #'dR/dA': 100,'dR/dC': 50,'dR/dR': 100} #, 'dR/dC': 50, 'dR/dL': 0.001, 'dR/dh2': 0.001}
mean_constr = 10
