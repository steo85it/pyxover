...
def plt_xovrms(df_):
    ...
    plt.savefig('/home/sberton2/Works/NASA/Mercury_tides/PyXover/tmp/xover_month.png')
    plt.close()
...
def analyze_sol(sol, ref_sol = '', subexp = ''):
    ...
    vecopts = {}
    tmp = Amat(vecopts)
    tmp = tmp.load('/home/sberton2/Works/NASA/Mercury_tides/out/sim/'+sol+'/'+subexp+'/Abmat_sim_'+sol.split('_')[0]+'_'+str(int(sol.split('_')[-1])+1)+'_'+subexp+'.pkl')
    ...
    # print_corrmat(ref,'/home/sberton2/Works/NASA/Mercury_tides/PyXover/tmp/corrmat_'+ref_sol+'.png')
    ...
    if True:
        ...
        ax1.invert_yaxis()
        #         ylabel='Topog ampl rms (1st octave, m)')
        fig.savefig('/home/sberton2/Works/NASA/Mercury_tides/PyXover/tmp/mla_count_'+sol+'_'+subexp+'.png')
        plt.clf()
        plt.close()
        ...
        if pd.Series(['dA', 'dC','dR']).isin(tmp.pert_cloop.columns).any():
            ...
            ax.set_ylabel('sol (m)')
            # ax.set_ylim(-300,300)
            plt.savefig('/home/sberton2/Works/NASA/Mercury_tides/PyXover/tmp/orbcorr_tseries_'+sol+'.png')
            plt.close()
            ...
            ax.set_ylabel('sol (m)')
            ax.set_ylim(-200,200)
            plt.savefig('/home/sberton2/Works/NASA/Mercury_tides/PyXover/tmp/residuals_tseries_'+sol+'_'+subexp+'.png')
            plt.close()
    ...
    if False:
        ...
        ax1.invert_yaxis()
        #         ylabel='Topog ampl rms (1st octave, m)')
        fig.savefig('/home/sberton2/Works/NASA/Mercury_tides/PyXover/tmp/mla_dL_'+sol+'.png')
        plt.clf()
        plt.close()
        ...
        ax1.invert_yaxis()
        #         ylabel='Topog ampl rms (1st octave, m)')
        fig.savefig('/home/sberton2/Works/NASA/Mercury_tides/PyXover/tmp/mla_dh2_'+sol+'.png')
        plt.clf()
        plt.close()
